...
import static com.mtanevski.master.gui.visualization.VisOptions.toWeb;
...
public class GraphStatisticsController {
    ...
    public void setGraphData(CaaGraph caaGraph) {
        ...
        happyVerticesData.getNode().setStyle(
                "-fx-pie-color: " + VisOptions.toWeb(p.get(PreferencesConstants.HAPPY_VERTEX_COLOR, DefaultValues.HAPPY_VERTEX_COLOR))
        );
        sadVerticesData.getNode().setStyle(
                "-fx-pie-color: " + VisOptions.toWeb(p.get(PreferencesConstants.SAD_VERTEX_COLOR, DefaultValues.SAD_VERTEX_COLOR))
        );
        otherVerticesData.getNode().setStyle(
                "-fx-pie-color: " + VisOptions.toWeb(p.get(PreferencesConstants.VERTICES_COLOR, DefaultValues.VERTICES_COLOR))
        );
    }
}
