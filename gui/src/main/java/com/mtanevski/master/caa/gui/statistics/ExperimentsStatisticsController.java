...
public class ExperimentsStatisticsController {
    ...
    public CaaExperimentSaveData caaExperimentSaveData;
    @FXML
    ...
    public void setGraphData(CaaExperimentSaveData caaExperimentSaveData) {
        this.caaExperimentSaveData = caaExperimentSaveData;
