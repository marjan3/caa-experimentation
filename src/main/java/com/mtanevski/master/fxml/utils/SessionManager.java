...
import static com.mtanevski.master.fxml.DefaultValues.SAMPLE_GRAPH_LOCATION;
import static com.mtanevski.master.fxml.utils.InterfaceSerializer.interfaceSerializer;
...
public class SessionManager {
    ...
    private static Gson gson = new GsonBuilder()
            .registerTypeAdapter(CaaGraph.class, interfaceSerializer(CaaGraphSnapshot.class))
            .registerTypeAdapter(CaaEdge.class, interfaceSerializer(WeightedCaaEdge.class))
            .registerTypeAdapter(CaaTraversalData.class, interfaceSerializer(CaaTraversalDataImpl.class))
            .setLenient()
            .create();
