...
public class UntraveledEdgeCaaAgentTest {
    ...
    public void shouldSelectMaxWeightEdge() {
        // given
        CaaEdge lowestWeightEdge = new CaaEdge("a", "b", -1.0, 2.0);
        CaaEdge middleWeightEdge = new CaaEdge("b", "c", 0.0, 0.0);
    ...
    public void shouldSelectMaxTraversalWeightEdgeWhenWeightsAreEqual() {
        // given
        CaaEdge lowestTraversalWeightEdge = new CaaEdge("a", "b", 0.0, -1.0);
        CaaEdge middleTraversalWeightEdge = new CaaEdge("b", "c", 0.0, 0.0);
        CaaEdge highestTraversalWeightEdge = new CaaEdge("c", "d", 0.0, 1.0);
